...
var extractComponentConfigs = function(options, componentName, existingParameters) {
        var componentConfig = {};
        if (existingParameters !== null && existingParameters !== undefined) {
            componentConfig = existingParameters;
        }
...
__.extend(HdiConfigClient.prototype, {
	...
	if(configFilePath){
		...
		components.forEach(function(componentName){
			...
			config.configurations[name] = null;		
		});
    ...
    addScriptAction: function(configFilePath, options, _) {
        ...
        if (scriptActions instanceof Array) {
            scriptActions.push(newAction);
        }
