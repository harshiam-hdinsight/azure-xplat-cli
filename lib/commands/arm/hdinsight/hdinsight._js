...
var hdInsightCommandLine = function (cli, userInteractor, executionProcessor) {
  ...
  if (executionProcessor) {
    ...
    this.createClusterCommand = function(clusterName, options, _) {
		...
		if(!utils.stringIsNullOrEmpty(options.hiveMetastoreServerName)
		...
		if(!utils.stringIsNullOrEmpty(options.oozieMetastoreServerName)
...
hdInsightCommandLine.init = function(cli) {
    ...
    config.command('add-config-values [configFilePath]')
        ...
        .option('--core-site <core-site>', $('Config values'))
        .option('--hive-site <hive-site>', $('Config values'))
        .option('--hive-env <hive-env>', $('Config values'))
        .option('--hdfs-site <hdfs-site>', $('Config values'))
        .option('--hbase-env <hbase-env>', $('Config values'))
        .option('--hbase-site <hbase-site>', $('Config values'))
        .option('--mapred-site <mapred-site>', $('Config values'))
        .option('--oozie-env <oozie-env>', $('Config values'))
        .option('--oozie-site <oozie-site>', $('Config values'))
        .option('--storm-site <storm-site>', $('Config values'))
        .option('--tez-site <tez-site>', $('Config values'))
        .option('--webhcat-site <webhcat-site>', $('Config values'))
        .option('--gateway <gateway>', $('Config values'))
        .option('--yarn <yarn>', $('Config values'))
        .option('-s, --subscription <id>', $('The subscription id'))
        .execute(function(configFilePath, options, _) {
