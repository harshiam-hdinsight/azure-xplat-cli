...
var RoleDefinitionOperations = ( /** @lends RoleDefinitionOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  RoleDefinitionOperations.prototype.get = function(roleDefinitionId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * 
   * @param {ListDefinitionFilterParameters} parameters List role definitions
   * filters.
   * 
   * @param {string} [parameters.roleName] Returns role definitions with this
   * name.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
   */
  RoleDefinitionOperations.prototype.listWithFilters = function(parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
